...
<body>
    ...
    <main class="container mt-4">
        ...
        <style>
            ...
            .card-container {
                margin-bottom: 20px;
                /* Adjust the margin bottom to reduce space between cards */
            }

            .card {
                margin-right: 10px;
                /* Adjust the margin right to reduce space between cards */
                margin-left: 10px;
                /* Adjust the margin left to reduce space between cards */
            }
        </style>
        <?php
